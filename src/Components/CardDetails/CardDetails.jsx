...
const CardDetails = () => {
    ...
    return (
        <div className='lg:w-[1100px] mx-auto font-poppins'>
            <div>
                <img className='mx-auto' src="https://i.ibb.co.com/0RF3dPX5/Screenshot-2025-03-05-165948.png" alt="Order Countdown" />
            </div>
            ...
            <div className="flex max-sm:flex-col max-sm:p-5 gap-6 mt-2 md:p-3">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-5">
                        ...
                        <div>
                            <img
                                className="w-[510px]"
                                src="https://i.ibb.co.com/cKXLfq5d/Screenshot-2025-03-05-215248.png"
                                alt=""
                            />
                        </div>
                    </div>
                ...
                <div className="flex-1 border-2 border-black border-opacity-20 p-3 rounded-lg shadow-md max-w-lg">
                    ...
                    <div>
                        <img src="https://i.ibb.co.com/yncmt1nf/Screenshot-2025-03-05-215457.png" alt="" />
                    </div>
                    <div className="text-center">
                        <h1 className="text-xl font-bold max-sm:text-lg">Cart Summary</h1>
                        <p className="text-2xl font-bold max-sm:text-lg">Mitolyn - 3 Bottles</p>
                        <div className="gap-3 p-1 max-sm:text-sm mb-2 flex items-center justify-center">
                            <p className="border text-white bg-red-700">9.4</p>
                            <p className="text-red-500"> Excellent! (34,182 reviews)</p>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='flex items-center justify-between'>
                            ...
                            <p className="line-through text-red-500 max-sm:text-xs">$591</p>
                        ...
                        <div className='flex items-center justify-between'>
                            ...
                            <p className=" text-red-500 max-sm:text-xs">-$444</p>
                        ...
                        <div className='flex items-center justify-between'>
                            ...
                            <p className=" text-black font-bold text-xl max-sm:text-xs ">$147</p>
                        ...
                        <div className='flex items-center justify-between mt-6'>
                            ...
                            <p className=" text-black  text-sm max-sm:text-xs "> $147.00</p>
                        ...
                        <div className='flex items-center justify-between mt-1'>
                            ...
                            <p className=" text-black  text-sm max-sm:text-xs ">$156.95</p>
                        </div>
                        ...
                        <div>
                            <img
                                className="w-[510px]"
                                src="https://i.ibb.co.com/zWjDvm7s/Screenshot-2025-03-05-230842.png"
                                alt=""
                            />
                        </div>
                ...
                <div className='flex gap-20 max-sm:flex-col mt-20'>
                    <div className='w-full sm:w-[500px] mx-auto'>
                        ...
                        <p className='text-sm'>ClickBank will allow for the return or replacement of any product within 90 days from the date of purchase. For more details see our return policy.
                            <span className='font-bold text-gray-400'> Your purchase will appear on your bank statement under the name CLKBANK*MITOLYN</span>.
                        </p>
                    </div>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center">
                    <div className='bg-red-700 p-12 rounded-xl shadow-lg max-w-lg w-full'>
                        ...
                        <p className='mt-4 text-center text-white text-lg'>
                            Your reserved bottles of Mitolyn will be given to someone else. <span className='underline decoration-white'>This action is final.</span>
                        </p>

                        <div className="bg-purple-200 bg-opacity-55 mt-6 py-3 rounded-lg">
                            <h2 className='text-center text-gray-700 text-lg font-bold'>
                                Click below to complete your purchase
                            </h2>
                        </div>

                        <div className="mt-8 flex justify-center gap-4">
                            <button className='bg-yellow-400 text-black text-sm py-2 px-6 rounded-lg shadow-md hover:bg-yellow-500 transition duration-300'>
                                Yes! I accept the discount! Give me my Mitolyn!
                            </button>
