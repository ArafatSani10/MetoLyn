                ...
                <div className="flex-1 border-2 border-black border-opacity-20 p-3 rounded-lg shadow-md max-w-lg">
                    ...
                    <div className="text-center">
                        ...
                        <div className="gap-3 p-1 max-sm:text-sm mb-2 flex items-center justify-center">
                            <p className="border text-white bg-red-700">9.5</p>
                            <p className="text-red-500"> Excellent!  (39,973 reviews)</p>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='flex items-center justify-between'>
                            ...
                            <p className="line-through text-red-500 max-sm:text-xs">$1182</p>

                        </div>

                        <div className='flex items-center justify-between'>
                            <h1 className='font-bold text-xl max-sm:text-sm'>Coupon: <span className='underline decoration-red-700 text-red-500'>80%OFF</span></h1>
                            <p className=" text-red-500 max-sm:text-xs">-$948</p>
                        ...
                        <div className='flex items-center justify-between'>
                            ...
                            <p className=" text-black font-bold text-xl max-sm:text-xs ">$234</p>
                        ...
                        <div className='flex items-center justify-between mt-6'>
                            ...
                            <p className=" text-black  text-sm max-sm:text-xs "> $234.00</p>
                        ...
                        <div className='flex items-center justify-between mt-1'>
                            ...
                            <p className=" text-black  text-sm max-sm:text-xs ">FREE</p>
